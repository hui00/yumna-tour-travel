...
- [ ] **Replace the remaining placeholder artwork**
      Every service page now has a photo. Multi-Day Packages, Tailor-Made Itinerary, Daily Tours and Rinjani Trekking use Muhajir's own photos from the Sembalun area and the north-coast waterfalls. The Jet Ski Rental photo is the weakest fit — it shows Gili boats (Unsplash, no attribution required), not a jet ski at all, because no such photo exists yet. Replace it first when Muhajir has one.
